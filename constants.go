...
const ReleaseUrl = "https://api.github.com/repos/Venticord/Venticord/releases/latest"
...
var UserAgent = "VenticordInstaller/" + InstallerGitHash + " (https://github.com/Venticord/Installer)"
